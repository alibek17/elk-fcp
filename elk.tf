...
resource "aws_instance" "elk" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
        ...
        "sudo sed -i 's/tobereplaced/elk.${var.domain}.conf/g' /etc/nginx/conf.d/elk.${var.domain}.conf",
        ...
        "sudo sed 's/output.elasticsearch/#output.elasticsearch/g' /etc/filebeat/filebeat.yml",
        "sudo sed 's/hosts: \\[\"localhost:9200\"\\]/#hosts: \\[\"localhost:9200\"\\]/g' /etc/filebeat/filebeat.yml",
        "sudo sed 's/#output.logstash/output.logstash/g' /etc/filebeat/filebeat.yml",
        "sudo sed 's/#hosts: \\[\"localhost:5044\"\\]/hosts: \\[\"localhost:5044\"\\]/g' /etc/filebeat/filebeat.yml",
